...
_DISTRO_RELEASE_IGNORE_BASENAMES = ('debian_version', 'lsb-release',
                                    'oem-release', _OS_RELEASE_BASENAME,
                                    'system-release')
...
class LinuxDistribution(object):
    ...
    def linux_distribution(self, full_distribution_name=True):
        ...
        """
        return (self.name() if full_distribution_name else self.id(),
    ...
    def _distro_release_info(self):
        ...
        if self.distro_release_file:
            ...
            try:
                ...
                basenames = [
                    'SuSE-release', 'arch-release', 'base-release',
                    'centos-release', 'fedora-release', 'gentoo-release',
                    'mageia-release', 'mandrake-release', 'mandriva-release',
                    'mandrivalinux-release', 'manjaro-release',
                    'oracle-release', 'redhat-release', 'sl-release',
                    'slackware-version'
                ]
