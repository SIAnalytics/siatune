...
from ..packages import rfc3986, six
from ..packages.rfc3986 import abnf_regexp, compat, misc, normalizers
...
def _encode_invalid_chars(component, allowed_chars, encoding='utf-8'):
    ...
    Based on rfc3986.normalizers.encode_component()
    """
    ...
    percent_encodings = len(
        normalizers.PERCENT_MATCHER.findall(
...
def parse_url(url):
    ...
    performed to parse incomplete urls. Fields not provided will be None. This
    ...
    if uri_ref.scheme is None or uri_ref.scheme.lower(
    ...
    try:
        validator.check_validity_of(
            *validator.COMPONENT_NAMES).validate(uri_ref)
