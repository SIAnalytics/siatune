...
_IP_ADDRESS_REGEX = re.compile(r'^(?:%s|%s|%s)$' %
                               (abnf_regexp.IPv4_RE, abnf_regexp.IPv6_RE,
...
def resolve_cert_reqs(candidate):
    ...
    wrap_socket function/method from the ssl module.
...
def is_ipaddress(hostname):
    """Detects whether the hostname given is an IPv4 or IPv6 address. Also
    detects IPv6 addresses with Zone IDs.
