...
class HTTPResponse(io.IOBase):
    ...
    def tell(self):
        ...
        :meth:``HTTPResponse.read`` if bytes are encoded on the wire (e.g,
        compressed).
        """
    ...
    def _flush_decoder(self):
        ...
        Should only be called if the decoder is actually being used.
        """
        if self._decoder:
    ...
    def supports_chunked_reads(self):
        ...
        We do this by testing for the fp attribute. If it is present we assume
        it returns raw chunks as processed by read_chunked().
        """
