...
class _BaseNetwork(_IPAddressBase):
    ...
    def hosts(self):
        ...
        This is like __iter__ except it doesn't return the network or broadcast
        addresses.
        """
    ...
    def _get_networks_key(self):
        ...
        This function is a suitable "key" argument for sorted() and
        list.sort().
        """
...
class _BaseV4(object):
    ...
    The following methods are used by IPv4 objects in both single IP addresses
    and networks.
    """
...
class IPv4Address(_BaseV4, _BaseAddress):
    ...
    @property
    def is_global(self):
        return (self not in self._constants._public_network
...
class _BaseV6(object):
    ...
    The following methods are used by IPv6 objects in both single IP addresses
    and networks.
    """
