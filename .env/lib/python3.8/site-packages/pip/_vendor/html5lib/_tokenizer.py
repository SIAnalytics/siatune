...
class HTMLTokenizer(object):
    ...
    * self.stream
    ...
    def consumeNumberEntity(self, isHex):
        ...
        It also discards ";" if present. If not present
        self.tokenQueue.append({"type": tokenTypes["ParseError"]}) is invoked.
        """
        ...
        if charAsInt in replacementCharacters:
            ...
            if ((0x0001 <= charAsInt <= 0x0008)
                    ...
                    or charAsInt in frozenset([
                        0x000B, 0xFFFE, 0xFFFF, 0x1FFFE, 0x1FFFF, 0x2FFFE,
    ...
    def markupDeclarationOpenState(self):
        ...
        if charStack[-1] == '-':
            ...
            matched = True
            for expected in (('o', 'O'), ('c', 'C'), ('t', 'T'), ('y', 'Y'),
                             ('p', 'P'), ('e', 'E')):
                charStack.append(self.stream.char())
