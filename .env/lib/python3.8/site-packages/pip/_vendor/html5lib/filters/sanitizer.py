...
svg_allow_local_href = frozenset(
    ((None, 'altGlyph'), (None, 'animate'), (None, 'animateColor'),
     (None, 'animateMotion'), (None, 'animateTransform'), (None, 'cursor'),
     (None, 'feImage'), (None, 'filter'), (None, 'linearGradient'),
     (None, 'pattern'), (None, 'radialGradient'), (None, 'textpath'),
     (None, 'tref'), (None, 'set'), (None, 'use')))
    ...
    def disallowed_token(self, token):
        ...
        if token_type == 'EndTag':
            ...
            for (ns, name), v in token['data'].items():
                attrs.append(' %s="%s"' % (name if ns is None else '%s:%s' %
