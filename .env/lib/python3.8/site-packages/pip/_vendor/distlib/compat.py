...
try:
    ...
    class ChainMap(MutableMapping):
        ...
        create a single, updateable view.
        ...
        def fromkeys(cls, iterable, *args):
            """Create a ChainMap with a single dict created from the
            iterable."""
...
try:
    ...
    class OrderedDict(dict):
        ...
        def __eq__(self, other):
            ...
            Comparison to another OD is order-sensitive while comparison to a
...
try:
    ...
    class BaseConfigurator(object):
        ...
        def convert(self, value):
            ...
            alternatives. Strings are checked to see if they have a conversion
            format and are converted if they do.
            """
