...
def rmtree(path, ignore_errors=False, onerror=None):
    ...
    sys.exc_info().  If ignore_errors is false and onerror is None, an
    exception is raised.
    """
    if ignore_errors:
...
def register_archive_format(name, function, extra_args=None, description=''):
    ...
    name is the name of the format. function is the callable that will be used
    to create archives. If provided, extra_args is a sequence of (name, value)
    tuples that will be passed as arguments to the callable. description can be
    provided to describe the format, and will be returned by the
