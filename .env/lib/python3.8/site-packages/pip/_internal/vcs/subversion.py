...
class Subversion(VersionControl):
    ...
    def get_netloc_and_auth(cls, netloc, scheme):
        """This override allows the auth information to be passed to svn via
        the.
    ...
    def get_remote_call_options(self):
        # type: () -> List[str]
        """Return options to be used on calls to Subversion that contact the
        server.
    ...
    def fetch_new(self, dest, url, rev_options):
        ...
        cmd_args = (['checkout', '-q'] + self.get_remote_call_options() +
