...
from pip._internal.utils.misc import (LOG_DIVIDER, call_subprocess,
                                      captured_stdout, ensure_dir,
                                      format_command_args, path_to_url,
                                      read_chunks)
...
if MYPY_CHECK_RUNNING:
    from typing import (Dict, List, Optional, Sequence, Mapping, Tuple, IO,
                        Text, Any, Iterable)
...
def fix_script(path):
    ...
    """Replace #!python with #!/path/to/python Return True if file was
    changed."""
...
def root_is_purelib(name, wheeldir):
    # type: (str, str) -> bool
    """Return True if the extracted wheel in wheeldir should go into
    purelib."""
...
def message_about_scripts_not_on_PATH(scripts):
    ...
    Returns a warning message if one or more scripts are not on PATH, otherwise
    None.
    """
    if not scripts:
        return None
...
class Wheel(object):
    ...
    def support_index_min(self, tags=None):
        ...
        """Return the lowest index that one of the wheel's file_tag
        combinations achieves in the supported_tags list e.g. if there are 8
        supported tags, and one of the file tags is first in the list, then
        return 0.
