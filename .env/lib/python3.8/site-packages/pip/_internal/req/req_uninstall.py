...
def compact(paths):
    ...
    contain all paths in the set. If /a/path/ and.

    /a/path/to/a/file.txt are both in the set, leave only the shorter path.
    """
...
class StashedUninstallPathSet(object):
    ...
    def _get_file_stash(self, path):
        ...
        If no root has been provided, one will be created for the directory in
