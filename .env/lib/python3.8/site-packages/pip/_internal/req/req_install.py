...
class InstallRequirement(object):
    """Represents something that may be installed later on, may have
    information about where to fetch the relevant requirement and also contains
    logic for installing the said requirement."""
    ...
    def has_hash_options(self):
        ...
        These activate --require-hashes mode; hashes specified as part of a URL
        do not.
        """
