...
def filter_unallowed_hashes(
    ...
    """Filter out candidates whose hashes aren't allowed, and return a new list
    of candidates.
    ...
    logger.debug(
        ...
        '(%s matches, %s no digest): %s', len(candidates), project_name,
        hashes.digest_count, match_count,
        len(matches_or_no_digest) - match_count, discard_message)
...
def _extract_version_from_fragment(fragment, canonical_name):
    ...
    """Parse the version string from a <package>+<version> filename "fragment"
...
def _clean_link(url):
    ...
    link, it will be rewritten to %20 (while not over-quoting.
