...
class TargetPython(object):
    """Encapsulates the properties of a Python interpreter one is targeting for
    a package install, download, etc."""
    ...
    def format_given(self):
        ...
        return ' '.join('{}={!r}'.format(key, value)
                        for key, value in key_values if value is not None)
