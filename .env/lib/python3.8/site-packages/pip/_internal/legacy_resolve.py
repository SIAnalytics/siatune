...
def _check_dist_requires_python(
    ...
    # type: (...) -> None
    """Check whether the given Python version is compatible with a
    distribution's "Requires-Python" value.
...
class Resolver(object):
    ...
    the requested operation without breaking the requirements of any
    package."""
    ...
    def resolve(self, requirement_set):
        ...
        self.require_hashes = (
            requirement_set.require_hashes
            or any(req.has_hash_options for req in root_reqs))
