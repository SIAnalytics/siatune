...
class AdjacentTempDirectory(TempDirectory):
    ...
    def _generate_names(cls, name):
        ...
        The algorithm replaces the leading characters in the name with ones
        that are valid filesystem characters, but are not valid package names
        (for both Python and pip definitions of package).
        """
