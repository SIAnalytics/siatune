...
class sdist(sdist_add_defaults, orig.sdist):
    ...
    #  Python.
    has_leaky_handle = (
        sys.version_info < (2, 7, 2) or (3, 0) <= sys.version_info < (3, 1, 4)
    ...
    def check_license(self):
        """Checks if license_file' is configured and adds it to 'self.filelist'
        if the value contains a valid path."""
