...
class upload(orig.upload):
    """Override default upload behavior to obtain password in a variety of
    different ways."""
    ...
    def run(self):
        try:
            ...
            self.announce(
                ...
                'to upload instead (https://pypi.org/p/twine/)', log.WARN)
    ...
    def _load_password_from_keyring(self):
        """Attempt to load password from keyring.
    ...
    def _prompt_for_password(self):
        """Prompt for a password on the tty.
