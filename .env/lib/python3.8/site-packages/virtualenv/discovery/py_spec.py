"""A Python specification is an abstract requirement definition of a
interpreter."""
...
class PythonSpec(object):
    ...
    def __init__(self, str_spec, implementation, major, minor, micro,
                 architecture, path):
    ...
    def generate_names(self):
        ...
        impls[
            'python'] = True  # finally consider python as alias, implementation must match now
    ...
    def satisfies(self, spec):
        ...
        for our, req in zip((self.major, self.minor, self.micro),
    ...
    def __unicode__(self):
        return '{}({})'.format(
            ...
            ', '.join('{}={}'.format(k, getattr(self, k))
                      for k in ('implementation', 'major', 'minor', 'micro',
                                'architecture', 'path')
