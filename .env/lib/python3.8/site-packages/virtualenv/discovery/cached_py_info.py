...
This operation is not cheap, especially not on Windows. To not have to pay this
hefty cost every time we apply multiple levels of caching.
"""
...
def _get_via_file_cache(cls, app_data, path, exe, env):
    ...
    with py_info_store.locked():
        if py_info_store.exists():  # if exists and matches load
            ...
            of_path, of_st_mtime, of_content = data['path'], data[
                'st_mtime'], data['content']
