...
class Session(object):
    ...
    @property
    def creator(self):
        """The creator used to build the virtual environment (must be
        compatible with the interpreter)"""
        return self._creator

    @property
    def seeder(self):
        """The mechanism used to provide the seed packages (pip, setuptools,
        wheel)"""
        return self._seeder
    ...
    def _create(self):
        logging.info('create virtual environment via %s',
                     ensure_text(str(self.creator)))
        self.creator.run()
