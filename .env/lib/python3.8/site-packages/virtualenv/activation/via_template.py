...
class ViaTemplateActivator(Activator):
    ...
    def generate(self, creator):
        ...
        generated = self._generate(replacements, self.templates(), dest_folder,
                                   creator)
    ...
    def replacements(self, creator, dest_folder):
        return {
            ...
            '__VIRTUAL_ENV__':
            ensure_text(str(creator.dest)),
            '__VIRTUAL_NAME__':
            creator.env_name,
            '__BIN_NAME__':
            ensure_text(str(creator.bin_dir.relative_to(creator.dest))),
            '__PATH_SEP__':
            ensure_text(os.pathsep),
        }
