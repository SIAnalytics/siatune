...
class Python2(ViaGlobalRefVirtualenvBuiltin, Python2Supports):
    ...
    def create(self):
        """Perform operations needed to make the created environment work on
        Python 2."""
        ...
        site_py_in = (
            self.stdlib_platform if
            ((sys_std_plat / 'site.py').exists() or
             (sys_std_plat / 'site.pyc').exists()) else self.stdlib)
