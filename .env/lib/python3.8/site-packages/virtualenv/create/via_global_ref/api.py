...
class ViaGlobalRefApi(Creator):
    ...
    def _should_symlink(options):
        ...
        copies, symlinks = getattr(options, 'copies',
                                   False), getattr(options, 'symlinks', False)
    ...
    def add_parser_arguments(cls, parser, interpreter, meta, app_data):
        super(ViaGlobalRefApi,
              cls).add_parser_arguments(parser, interpreter, meta, app_data)
        parser.add_argument(
    ...
    def install_patch(self):
        ...
        if text:
            ...
            logging.debug('create virtualenv import hook file %s',
                          ensure_text(str(pth)))
    ...
    def env_patch_text(self):
        """Patch the distutils package to not be derailed by its configuration
        files."""
