...
class Describe(object):
    """Given a host interpreter tell us information about what the created
...
class Python2Supports(Describe):
    ...
    def can_describe(cls, interpreter):
        return interpreter.version_info.major == 2 and super(
            Python2Supports, cls).can_describe(interpreter)
...
class Python3Supports(Describe):
    ...
    def can_describe(cls, interpreter):
        return interpreter.version_info.major == 3 and super(
            Python3Supports, cls).can_describe(interpreter)
...
class PosixSupports(Describe):
    ...
    def can_describe(cls, interpreter):
        return interpreter.os == 'posix' and super(
            PosixSupports, cls).can_describe(interpreter)
...
class WindowsSupports(Describe):
    ...
    @classmethod
    def can_describe(cls, interpreter):
        return interpreter.os == 'nt' and super(WindowsSupports,
