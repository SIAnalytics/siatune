...
def filter_by_include_exclude(
    ...
    return [
        filename for filename in names if include_re.search(filename)
...
class Classifier:
    ...
    def by_types(
        ...
        for filename in names:
            ...
            if (tags >= types and (not types_or or tags & types_or)
...
def _compute_cols(hooks: Sequence[Hook]) -> int:
    """Compute the number of columns to display hook messages.  The widest that
    will be displayed is in the no files skipped case:
