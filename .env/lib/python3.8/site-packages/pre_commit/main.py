...
def _add_run_options(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        '--is-squash-merge',
        help=('During a post-merge hook, indicates whether the merge was a '
              'squash merge'),
    )
    parser.add_argument(
        '--rewrite-command',
        help=('During a post-rewrite hook, specifies the command that invoked '
              'the rewrite'),
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    autoupdate_parser.add_argument(
        '--bleeding-edge',
        action='store_true',
        help=('Update to the bleeding edge of `HEAD` instead of the latest '
