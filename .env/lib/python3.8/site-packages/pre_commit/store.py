...
def _get_default_directory() -> str:
    ...
    This is intentionally underscored to indicate that
    `Store.get_default_directory` is the intended way to get this information.
    This is also done so `Store.get_default_directory` can be mocked in tests
    and `_get_default_directory` can be tested.
    """
...
class Store:
    ...
    def __init__(self, directory: str | None = None) -> None:
        ...
        self.readonly = (
            ...
            and not os.access(self.directory, os.W_OK))
